# Scaffold Bootstrap Prompt

## Purpose

Guide first-session orientation and validation for this scaffolded repository.
...
- Bootstrap docs, recipes, and checklists are aligned to current implementation.
