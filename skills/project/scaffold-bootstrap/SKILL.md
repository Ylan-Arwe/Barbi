# Skill: Scaffold Bootstrap

## Description
Initialize a new session in this scaffolded repository with the minimum context pack and wrapper discipline.

## When to use
- Starting first meaningful work in this scaffolded repository.
- Aligning contributors and agents on required ingestion order and evidence packaging policy.
