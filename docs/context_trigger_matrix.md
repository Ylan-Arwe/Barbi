...
| Scaffold bootstrap artifact generation | `docs/agent_bootstrap/README.md` -> `scripts/README.md` -> `AGENTS.md` | `context/README.md` | `python scripts/aggregate_project_docstrings.py ...`; `python scripts/audit_docstrings.py ...` | Artifact contract respected (commit JSON catalog, keep local evidence untracked). |
