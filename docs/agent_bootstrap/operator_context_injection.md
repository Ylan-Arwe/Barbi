...
This playbook defines the minimum context pack that stateless coding agents should ingest before making workflow or code changes in this repository scaffold.
